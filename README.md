...
wget -N --no-check-certificate https://github.com/tpe28/Misaka-WARP-Script/releases/download/release/misakawarp.sh && sed -i 's/\r//' misakawarp.sh && bash misakawarp.sh
```
